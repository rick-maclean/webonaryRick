...
function themezee_admin_add_page() {
	add_theme_page(THEME_NAME.' '. __('Options', ZEE_LANG), THEME_NAME.' '. __('Options', ZEE_LANG), 'edit_theme_options', 'themezee', 'themezee_options_page');
}
...
?>
	<div class="wrap zee_admin_wrap">  			
		...
		<h2><?php echo THEME_NAME; ?> <?php _e('Options', ZEE_LANG); ?></h2>
		
		<p><?php _e('It is completely optional, but if you like the Theme I would appreciate it if you keep the credit link at the bottom.', ZEE_LANG); ?></p>
