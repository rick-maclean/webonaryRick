...
// -->
	...
	<?php wp_footer();?>
		...
		<div id="footer" class=<?php echo $color; ?> style="text-align:center; padding-bottom: 8px; font-size:12px;">
			...
			<div style="float:left;"><img src="<?php echo  get_template_directory_uri(); ?>/images/sil-icon.gif" style="vertical-align:middle;"> <a href="http://www.webonary.org" target="_blank" style="margin-left:20px;">Webonary.org</a></div> 
			<span>© 2014 <a href="http://www.sil.org" target="_blank">SIL International</a><sup>®</sup></span>
			<div style="float:right;"><a href="http://webonary.org/sil-international-terms-of-service-for-webonary-org/"><?php _e('Terms of Service'); ?></a></div>
		</div>					
	</div>
</div>
</body>
